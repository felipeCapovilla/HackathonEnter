...
export function Recomendacao({ recomendacao, precisaAvaliar, onAvaliar, ocupado }) {
  if (!recomendacao) {
    return <PainelRecolhivel group="evaluation" titulo="Recomendação" resumo={ocupado ? "Calculando a recomendação…" : "Aguardando documentos"}><article className="panel recomendacao">
